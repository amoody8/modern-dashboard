...
check( 'unknown cards dropped', $clean['visible_cards'], [ 'sites' ] );
...
$empty = $settings->sanitize( [ 'visible_cards' => [] ] );
check( 'empty card list restores defaults', $empty['visible_cards'], Settings::CARDS );
